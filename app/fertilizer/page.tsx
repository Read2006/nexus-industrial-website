  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#fff' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .fer-hero{position:relative;min-height:85vh;display:flex;align-items:center;padding:72px 24px;overflow:hidden;background:transparent}.fer-hero::before{content:'';position:absolute;inset:0;background:url('/new-heroes/fertilizer.jpeg') center/cover no-repeat;z-index:0}.fer-hero::after{content:'';position:absolute;inset:0;background:rgba(5,46,22,0.75);z-index:1}.fer-hero-left{position:relative;z-index:2;max-width:720px}.fer-hero-right{display:none !important}
        ...
        @media (max-width: 600px){
          .fer-hero{padding: 40px 24px !important;min-height:70vh !important}
        ...
        <section className="fer-hero">
          ...
          <div className="fer-hero-right">
            <div className="fer-img-wrap">
              <img src="/new-heroes/fertilizer.jpeg" alt="fertilizer industry" />
            </div>
          </div>
        </section>
      ...
      <div className="flex-1 w-full font-sans text-gray-800 bg-white">
        ...
        <section className="py-24 px-6 md:px-12 flex flex-col items-center bg-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 w-full max-w-6xl items-center">
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square">
              ...
              <div className="absolute bottom-0 right-[10%] bg-white p-5 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] z-30 flex items-center gap-6 border border-gray-100 min-w-[280px]">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#65a30d] text-white rounded-xl flex items-center justify-center text-2xl shadow-sm">🛡️</div>
                  <div>
            ...
            {/* Right Col: Content */}
            <div>
              <div className="bg-lime-50 text-[#65a30d] border border-lime-100 text-[10px] font-bold px-3 py-1.5 rounded-full mb-4 uppercase tracking-wider inline-flex items-center gap-1.5">
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight leading-[1.1]">
                Global Leader in <span className="text-[#65a30d]">Fertilizer Technology</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-10">
                <div className="bg-lime-50/50 border border-lime-100 rounded-lg p-4 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#65a30d] text-white rounded-lg flex items-center justify-center text-lg shrink-0">📈</div>
                  <div>
                    <div className="text-gray-500 text-[11px] mb-0.5 font-medium">Plant Availability</div>
                    <div className="text-[#65a30d] font-bold text-lg leading-none">98.5%</div>
                  </div>
                </div>
                <div className="bg-lime-50/50 border border-lime-100 rounded-lg p-4 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#65a30d] text-white rounded-lg flex items-center justify-center text-lg shrink-0">⚡</div>
                  <div>
                    ...
                    <div className="text-[#65a30d] font-bold text-lg leading-none">28 GJ/MT</div>
                  </div>
                </div>
                <div className="bg-lime-50/50 border border-lime-100 rounded-lg p-4 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#65a30d] text-white rounded-lg flex items-center justify-center text-lg shrink-0">🎯</div>
                  <div>
                    ...
                    <div className="text-[#65a30d] font-bold text-lg leading-none">99.9%</div>
                  </div>
                </div>
                <div className="bg-lime-50/50 border border-lime-100 rounded-lg p-4 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#65a30d] text-white rounded-lg flex items-center justify-center text-lg shrink-0">🌿</div>
                  <div>
                    ...
                    <div className="text-[#65a30d] font-bold text-lg leading-none">Zero LLD</div>
                  </div>
                </div>
              </div>

              <a href="/about" className="inline-flex bg-[#65a30d] hover:bg-lime-500 text-white px-7 py-3 rounded font-semibold text-sm items-center gap-2 transition shadow-md">
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-white border-t border-gray-100">
          <div className="bg-lime-50 text-[#65a30d] border border-lime-100 text-[10px] font-bold px-4 py-1.5 rounded-full mb-4 uppercase tracking-wider inline-flex items-center gap-1.5">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3 text-center tracking-tight">
            Industrial <span className="text-[#65a30d]">Equipment Portfolio</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-7xl">
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-6 bg-white flex-1 flex flex-col">
                <ul className="space-y-3 mb-6 text-[12.5px] text-gray-600">
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Ammonia Synthesis Converters (Radial/Axial Flow)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Urea High Pressure Reactors (200-250 bar)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Nitric Acid Absorption Towers</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Sulfuric Acid Contact Towers</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Phosphoric Acid Reactors/Digesters</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Ammonium Nitrate Neutralizers</li>
                </ul>
                <a href="/products" className="mt-auto text-[#65a30d] text-[13px] font-bold hover:text-lime-700 inline-flex items-center gap-1">
                  View Specifications →
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-6 bg-white flex-1 flex flex-col">
                <ul className="space-y-3 mb-6 text-[12.5px] text-gray-600">
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Primary & Secondary Reformers</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Waste Heat Boilers (Steam Generation)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Process Gas Heaters/Coolers</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Carbamate Condensers (HP/LP)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Evaporators (Falling Film/Forced Circulation)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Steam Superheaters & Economizers</li>
                </ul>
                <a href="/products" className="mt-auto text-[#65a30d] text-[13px] font-bold hover:text-lime-700 inline-flex items-center gap-1">
                  View Specifications →
                </a>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-6 bg-white flex-1 flex flex-col">
                <ul className="space-y-3 mb-6 text-[12.5px] text-gray-600">
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> CO2 Removal Systems (MDEA/Benfield)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Ammonia Recovery Units</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Phosphoric Acid Filtration Systems</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Crystallizers & Centrifuges</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Molecular Sieve Dryers</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Distillation Columns</li>
                </ul>
                <a href="/products" className="mt-auto text-[#65a30d] text-[13px] font-bold hover:text-lime-700 inline-flex items-center gap-1">
                  View Specifications →
                </a>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              <div className="h-48 relative overflow-hidden">
                <img src="/new-heroes/fertilizer.jpeg" alt="Granulation & Finishing" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/30 to-transparent"></div>
                <div className="absolute bottom-4 left-4 flex items-center gap-3">
              ...
              <div className="p-6 bg-white flex-1 flex flex-col">
                <ul className="space-y-3 mb-6 text-[12.5px] text-gray-600">
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Prilling Towers (200-300m height)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Drum Granulators (Ø3-5m)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Fluidized Bed Granulators</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Rotary Dryers & Coolers</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Coating & Conditioning Systems</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Screening & Classification Equipment</li>
                </ul>
                <a href="/products" className="mt-auto text-[#65a30d] text-[13px] font-bold hover:text-lime-700 inline-flex items-center gap-1">
                  View Specifications →
                </a>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-6 bg-white flex-1 flex flex-col">
                <ul className="space-y-3 mb-6 text-[12.5px] text-gray-600">
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Belt Conveyors (Covered/Open)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Bucket Elevators (High Capacity)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Pneumatic Conveying Systems</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Screw Conveyors & Feeders</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Storage Silos & Bins</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Ship/Rail/Truck Loading Systems</li>
                </ul>
                <a href="/products" className="mt-auto text-[#65a30d] text-[13px] font-bold hover:text-lime-700 inline-flex items-center gap-1">
                  View Specifications →
                </a>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-6 bg-white flex-1 flex flex-col">
                <ul className="space-y-3 mb-6 text-[12.5px] text-gray-600">
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Automatic Bagging Machines (50kg/1MT)</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> FFS (Form-Fill-Seal) Lines</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Palletizing & Stretch Wrapping</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Bulk Loading Systems</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Weighing & Quality Control</li>
                  <li className="flex items-start gap-2"><span className="text-[#65a30d] mt-0.5 text-sm">›</span> Warehouse Management Systems</li>
                </ul>
                <a href="/products" className="mt-auto text-[#65a30d] text-[13px] font-bold hover:text-lime-700 inline-flex items-center gap-1">
                  View Specifications →
                </a>
        ...
        <section className="py-24 px-6 md:px-12 flex flex-col items-center bg-[#283243] relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 opacity-20" style={{ backgroundImage: 'url(/new-heroes/fertilizer.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
          ...
          <div className="bg-[#1f2937] text-white border border-gray-600 text-[10px] font-bold px-4 py-1.5 rounded-full mb-4 uppercase tracking-wider inline-flex items-center gap-1.5 relative z-10 shadow-sm">
            <svg className="w-3 h-3 text-[#65a30d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>
            PRODUCTION PROCESS
          </div>
          <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-3 text-center tracking-tight relative z-10">
            Fertilizer <span className="text-[#65a30d]">Production Flow</span>
          </h2>
          ...
          <div className="w-full max-w-6xl relative z-10 overflow-x-auto pt-4 pb-4 custom-scrollbar">
            <div className="min-w-[900px] flex justify-between relative px-2">
              {/* Connecting Line */}
              <div className="absolute top-[32px] left-[8%] right-[8%] h-[1px] bg-[#65a30d]/50 z-0"></div>
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-[140px] group">
                ...
                <div className="w-16 h-16 rounded-full bg-[#1e293b] border-2 border-transparent group-hover:border-[#65a30d] transition-colors text-white flex items-center justify-center text-2xl shadow-lg mb-5 relative">
                  🗻
                </div>
                ...
                <div className="text-[#65a30d] font-bold text-[10px]">Feed Purity: {'>'}99%</div>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-[140px] group">
                ...
                <div className="w-16 h-16 rounded-full bg-[#65a30d] text-white flex items-center justify-center text-2xl shadow-lg mb-5 relative shadow-[#65a30d]/30">
                  🔥
                </div>
                ...
                <div className="text-[#65a30d] font-bold text-[10px]">Temp: 850-1050°C</div>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-[140px] group">
                ...
                <div className="text-[#65a30d] font-bold text-[10px]">Pressure: 150-250 bar</div>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-[140px] group">
                ...
                <div className="text-[#65a30d] font-bold text-[10px]">Recovery: {'>'}99%</div>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-[140px] group">
                ...
                <div className="text-[#65a30d] font-bold text-[10px]">Size: 2-4mm</div>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-[140px] group">
                ...
                <div className="text-[#65a30d] font-bold text-[10px]">Capacity: 10,000 MT</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-gray-50 border-t border-gray-100">
          <div className="bg-sky-100 text-[#65a30d] text-[10px] font-bold px-4 py-1.5 rounded-full mb-4 uppercase tracking-wider inline-flex items-center gap-1.5">
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
            OUR SERVICES
          </div>
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3 text-center tracking-tight">
            End-to-End <span className="text-[#65a30d]">EPC Services</span>
          </h2>
          <p className="text-gray-500 mb-14 text-center max-w-2xl text-[15px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-7xl">
            ...
            <div className="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-[#65a30d] text-white rounded-lg flex items-center justify-center text-xl mb-6 shadow-sm">📄</div>
            ...
            {/* Card 2 */}
            <div className="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-[#65a30d] text-white rounded-lg flex items-center justify-center text-xl mb-6 shadow-sm">⚙️</div>
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-[#f8fafc] border-t border-gray-100 pb-28">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3 text-center tracking-tight">
            Industrial <span className="text-[#65a30d]">Standards</span> & Certifications
          </h2>
          <p className="text-gray-500 mb-14 text-center max-w-2xl text-[15px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 bg-lime-50 text-[#65a30d] rounded-lg flex items-center justify-center text-lg shrink-0">✓</div>
              <div>
                <div className="text-[#65a30d] text-[10px] font-bold uppercase tracking-wider mb-0.5">Quality</div>
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 bg-lime-50 text-[#65a30d] rounded-lg flex items-center justify-center text-lg shrink-0">✓</div>
              <div>
                <div className="text-[#65a30d] text-[10px] font-bold uppercase tracking-wider mb-0.5">Environment</div>
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 bg-lime-50 text-[#65a30d] rounded-lg flex items-center justify-center text-lg shrink-0">✓</div>
              <div>
                <div className="text-[#65a30d] text-[10px] font-bold uppercase tracking-wider mb-0.5">Safety</div>
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 bg-lime-50 text-[#65a30d] rounded-lg flex items-center justify-center text-lg shrink-0">✓</div>
              <div>
                <div className="text-[#65a30d] text-[10px] font-bold uppercase tracking-wider mb-0.5">Equipment</div>
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 bg-lime-50 text-[#65a30d] rounded-lg flex items-center justify-center text-lg shrink-0">✓</div>
              <div>
                <div className="text-[#65a30d] text-[10px] font-bold uppercase tracking-wider mb-0.5">Process</div>
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 bg-lime-50 text-[#65a30d] rounded-lg flex items-center justify-center text-lg shrink-0">✓</div>
              <div>
                <div className="text-[#65a30d] text-[10px] font-bold uppercase tracking-wider mb-0.5">Materials</div>
