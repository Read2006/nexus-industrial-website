...
:root{--navy:#0d1b2e;--navy2:#0f2137;--navy3:#162840;--teal:#0d9488;--teal2:#14b8a6;--emerald:#10b981;--emerald2:#34d399;--blue:#2563eb;--green:#16a34a;--green2:#4ade80;--white:#fff;--gray:#94a3b8}
...
.hero-badge{display:inline-flex;align-items:center;gap:8px;background:rgba(13,148,136,.15);border:1px solid rgba(13,148,136,.4);color:var(--teal);font-size:11px;font-weight:700;letter-spacing:1.5px;padding:8px 12px;border-radius:999px}
...
.tag-pill{display:inline-flex;align-items:center;gap:8px;background:rgba(13,148,136,.1);border:1px solid rgba(13,148,136,.3);color:var(--teal);font-size:11px;font-weight:700;letter-spacing:1.5px;padding:8px 12px;border-radius:999px}
...
.vc-list li::before{content:'✓';width:19px;height:19px;min-width:19px;background:#d1fae5;color:var(--teal);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:10px}
...
.s-tag{display:inline-flex;align-items:center;gap:8px;background:rgba(16,185,129,.2);border:1px solid rgba(16,185,129,.4);color:#4ade80;font-size:11px;font-weight:700;letter-spacing:1.5px;padding:8px 12px;border-radius:999px}
...
.lc-tag{display:inline-flex;align-items:center;gap:8px;background:rgba(13,148,136,.1);border:1px solid rgba(13,148,136,.25);color:var(--teal);font-size:11px;font-weight:700;letter-spacing:1.5px;padding:8px 12px;border-radius:999px}
...
.tl-ico{width:76px;height:76px;background:var(--teal);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:26px;margin:0 auto 16px;position:relative;z-index:1;transition:transform .25s}
...
.cta p{color:var(--gray);font-size:16px;max-width:480px;margin:0 auto 32px;line-height:1.7}
...
<section class="safety">
  ...
  <div class="s-cnt">
    ...
    <div class="s-cards">
      <div class="s-card"><div class="s-card-top"><div class="s-card-ico">✅</div><div class="s-val">99.7%</div></div><h4>Quality Yield</h4><p>First-pass quality yield across all textile products.</p></div>
      <div class="s-card"><div class="s-card-top"><div class="s-card-ico">🌱</div><div class="s-val">100%</div></div><h4>Sustainable</h4><p>Commitment to eco-friendly and sustainable manufacturing practices.</p></div>
