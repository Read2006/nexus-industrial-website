    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .tag-pill{display:inline-flex;align-items:center;gap:8px;background:rgba(13,148,136,.1);border:1px solid rgba(13,148,136,.3);color:var(--teal);font-size:11px;font-weight:700;letter-spacing:1.5px;padding:7px 16px;border-radius:20px;text-transform:uppercase;margin-bottom:18px}
        ...
        .vc-list li::before{content:'✓';width:19px;height:19px;min-width:19px;background:#d1fae5;color:var(--teal);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700}
        ...
        .s-tag{display:inline-flex;align-items:center;gap:8px;background:rgba(16,185,129,.2);border:1px solid rgba(16,185,129,.4);color:#4ade80;font-size:11px;font-weight:700;letter-spacing:1.5px;padding:7px 16px;border-radius:20px;text-transform:uppercase;margin-bottom:18px}
        ...
        .lc-tag{display:inline-flex;align-items:center;gap:8px;background:rgba(13,148,136,.1);border:1px solid rgba(13,148,136,.25);color:var(--teal);font-size:11px;font-weight:700;letter-spacing:1.5px;padding:7px 16px;border-radius:20px;text-transform:uppercase;margin-bottom:18px}
      ...
      <section className="hero">
        <div className="hero-left">
          <div className="hero-badge">🧵 TEXTILE INDUSTRY SOLUTIONS</div>
          <h1>Powering Global<span className="teal">Textile Operations</span></h1>
          <p className="hero-desc">Comprehensive solutions for fiber production, yarn manufacturing, fabric processing, and finished textile products. Trusted by leading textile companies across 40+ countries.</p>
          <div className="hero-stats">
            <div><div className="hs-num">200+</div><div className="hs-lbl">Projects</div></div>
            <div><div className="hs-num">30+</div><div className="hs-lbl">Years</div></div>
            <div><div className="hs-num">40+</div><div className="hs-lbl">Countries</div></div>
          </div>
          <div className="hero-btns">
            <a href="#" className="btn-teal">Request Quote →</a>
            <a href="#" className="btn-drk">▶ View Capabilities</a>
          </div>
        </div>
        <div className="hero-right">
          <div className="hero-img-wrap">
            ...
            <div className="fc tr">
              ...
              <div><div className="fn">8M+</div><div className="fl">Safe Man-Hours</div></div>
            </div>
            <div className="fc bl">
        ...
        <div className="explore">EXPLORE<div className="mouse"></div></div>
      </section>

      {/* STATS SECTION */}
      <section className="stats">
        <div className="stats-grid">
          <div className="sc"><div className="sc-icon">📋</div><div className="num">200+</div><div className="lbl">Projects Delivered</div></div>
          <div className="sc"><div className="sc-icon">🏆</div><div className="num">30+</div><div className="lbl">Years Experience</div></div>
          <div className="sc"><div className="sc-icon">🌐</div><div className="num">40+</div><div className="lbl">Countries Served</div></div>
          <div className="sc"><div className="sc-icon">⛑️</div><div className="num">8M+</div><div className="lbl">Safe Man-Hours</div></div>
        </div>
      </section>
      ...
      <section className="vc-section">
        <div className="sec-center">
          <div className="tag-pill">🔗 TEXTILE VALUE CHAIN</div>
          <h2>Complete <span>Textile</span> Manufacturing Chain</h2>
          <p className="sec-sub">End-to-end solutions covering every segment of textile production</p>
        </div>
        <div className="vc-grid">
          <div className="vcc">
            <div className="vch teal"><div className="vch-icon">🌾</div><h3>Fiber Production</h3><p>Natural &amp; Synthetic Fibers</p></div>
            <div className="vcb">
              <p className="desc">Equipment and services for cotton, wool, polyester, nylon, and specialty fiber production.</p>
              <div className="vcm"><div><div className="vm-val">50+</div><div className="vm-lbl">Projects</div></div><div><div className="vm-val g">99.5%</div><div className="vm-lbl">Uptime</div></div></div>
              <ul className="vc-list"><li>Cotton Ginning</li><li>Polymer Extrusion</li><li>Staple Fiber Lines</li><li>Bale Press Systems</li></ul>
            </div>
          </div>
          <div className="vcc">
            <div className="vch emerald"><div className="vch-icon">🔄</div><h3>Yarn Manufacturing</h3><p>Spinning &amp; Twisting</p></div>
            <div className="vcb">
              <p className="desc">Complete spinning solutions including blow room, carding, drawing, roving, and ring spinning.</p>
              <div className="vcm"><div><div className="vm-val">80+</div><div className="vm-lbl">Projects</div></div><div><div className="vm-val g">99.3%</div><div className="vm-lbl">Uptime</div></div></div>
              <ul className="vc-list"><li>Ring Spinning</li><li>Open End Rotor</li><li>Air Jet Spinning</li><li>Twisting Machines</li></ul>
            </div>
          </div>
          <div className="vcc">
            <div className="vch cyan"><div className="vch-icon">📊</div><h3>Fabric Processing</h3><p>Weaving &amp; Knitting</p></div>
            <div className="vcb">
              <p className="desc">Advanced weaving, knitting, and non-woven fabric production technologies.</p>
              <div className="vcm"><div><div className="vm-val">70+</div><div className="vm-lbl">Projects</div></div><div><div className="vm-val g">98.9%</div><div className="vm-lbl">Uptime</div></div></div>
              <ul className="vc-list"><li>Air Jet Looms</li><li>Rapier Looms</li><li>Circular Knitting</li><li>Non-Woven Lines</li></ul>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="safety">
        <img className="s-bg" src="https://images.unsplash.com/photo-1532453288672-3a27e9be9efd?w=1600&q=80" alt="Textile quality control"/>
        <div className="s-ov"></div>
        <div className="s-cnt">
          <div className="s-tag">🏭 QUALITY &amp; SUSTAINABILITY</div>
          <h2>Excellence in <span>Textile Manufacturing</span></h2>
          <p className="s-sub">Commitment to quality, sustainability, and ethical production across all textile operations.</p>
          <div className="s-cards">
            <div className="s-card"><div className="s-card-top"><div className="s-card-ico">✅</div><div className="s-val">99.7%</div></div><h4>Quality Yield</h4><p>First-pass quality yield across all textile products</p></div>
            <div className="s-card"><div className="s-card-top"><div className="s-card-ico">🌱</div><div className="s-val">100%</div></div><h4>Sustainable</h4><p>Commitment to eco-friendly and sustainable manufacturing</p></div>
            <div className="s-card"><div className="s-card-top"><div className="s-card-ico">⚡</div><div className="s-val">15%</div></div><h4>Energy Reduction</h4><p>Average energy savings through modern efficient equipment</p></div>
            <div className="s-card"><div className="s-card-top"><div className="s-card-ico">🏅</div><div className="s-val">ISO</div></div><h4>Quality Assurance</h4><p>ISO 9001 and OEKO-TEX certified quality systems</p></div>
          </div>
          <div className="cert-row">
            <div className="ci"><span className="ci-chk">✓</span><div><strong>OEKO-TEX</strong><span>Standard 100</span></div></div>
            <div className="ci"><span className="ci-chk">✓</span><div><strong>GOTS</strong><span>Organic Certified</span></div></div>
            <div className="ci"><span className="ci-chk">✓</span><div><strong>ISO 9001</strong><span>Quality Systems</span></div></div>
            <div className="ci"><span className="ci-chk">✓</span><div><strong>ISO 14001</strong><span>Environmental</span></div></div>
            <div className="ci"><span className="ci-chk">✓</span><div><strong>BS OHSAS</strong><span>Health &amp; Safety</span></div></div>
            <div className="ci"><span className="ci-chk">✓</span><div><strong>GRS</strong><span>Recycled Claim</span></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="lifecycle">
        <div className="sec-center">
          <div className="lc-tag">🔄 TEXTILE MANUFACTURING PROCESS</div>
          <h2>From Fiber to <span>Finished Fabric</span></h2>
          <p className="sec-sub">Our solutions support every stage of textile production</p>
        </div>
        <div className="tl">
          <div className="tl-s"><div className="tl-ico">🌾</div><div className="tl-num">STEP 01</div><h4>Fiber Production</h4><p>Natural fiber processing and synthetic fiber extrusion for raw material preparation</p></div>
          <div className="tl-s"><div className="tl-ico">🔄</div><div className="tl-num">STEP 02</div><h4>Spinning</h4><p>Conversion of fibers into yarn through blow room, carding, drawing, and roving.</p></div>
          <div className="tl-s"><div className="tl-ico">📊</div><div className="tl-num">STEP 03</div><h4>Weaving/Knitting</h4><p>Fabric formation using advanced looms and knitting machines.</p></div>
          <div className="tl-s"><div className="tl-ico">🎨</div><div className="tl-num">STEP 04</div><h4>Processing</h4><p>Pretreatment, dyeing, printing, and finishing of fabrics.</p></div>
          <div className="tl-s"><div className="tl-ico">👕</div><div className="tl-num">STEP 05</div><h4>Garmenting</h4><p>Cutting, sewing, and assembly of finished textile products.</p></div>
          <div className="tl-s"><div className="tl-ico" style={{background:'#111827'}}>📦</div><div className="tl-num">STEP 06</div><h4>Distribution</h4><p>Packaging and global logistics for textile products.</p></div>
        </div>
      </section>
      ...
      <section className="products-section">
        <div className="sec-center">
          <div className="tag-pill">🏭 TEXTILE EQUIPMENT</div>
          <h2>Advanced <span>Textile Machinery</span></h2>
          <p className="sec-sub">State-of-the-art equipment for modern textile manufacturing</p>
        </div>
        <div className="products-grid">
          <div className="prod-card"><div className="prod-img">🏭</div><div className="prod-info"><h4>Spinning Machinery</h4><p>Ring frames, rotor spinning, blow room lines, and carding machines.</p></div></div>
          <div className="prod-card"><div className="prod-img">📊</div><div className="prod-info"><h4>Weaving Looms</h4><p>Air jet, rapier, projectile, and water jet looms for all fabric types.</p></div></div>
          <div className="prod-card"><div className="prod-img">🔵</div><div className="prod-info"><h4>Knitting Machines</h4><p>Circular knitting, flat knitting, and warp knitting equipment.</p></div></div>
          <div className="prod-card"><div className="prod-img">🎨</div><div className="prod-info"><h4>Dyeing & Finishing</h4><p>Jet dyeing, padding, stenter frames, and calendering machines.</p></div></div>
        </div>
      </section>
      ...
      <section className="cta">
        ...
        <div className="cta-btns"><a href="#" className="btn-teal">Request a Quote →</a><a href="#" className="btn-drk">View All Products</a></div>
      </section>
    </>
  )
}
