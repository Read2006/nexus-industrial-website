  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#fff' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .pwr-hero{position:relative;min-height:85vh;display:flex;align-items:center;padding:72px 24px;overflow:hidden;background:transparent}.pwr-hero::before{content:'';position:absolute;inset:0;background:url('/new-heroes/power.jpeg') center/cover no-repeat;z-index:0}.pwr-hero::after{content:'';position:absolute;inset:0;background:rgba(46,16,3,0.78);z-index:1}.pwr-hero-left{position:relative;z-index:2;max-width:720px}.pwr-hero-right{display:none !important}
        ...
        .pwr-fc-icon{width:34px;height:34px;background:#eab308;border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0}
        ...
        @media (max-width: 600px){
          .pwr-hero{padding: 40px 24px !important;min-height:70vh !important}
        ...
        <section className="pwr-hero">
          ...
          <div className="pwr-hero-right">
            <div className="pwr-img-wrap">
              <img src="/new-heroes/power.jpeg" alt="power industry" />
            </div>
          </div>
        </section>
      ...
      <div className="flex-1 w-full font-sans text-gray-800 bg-white">
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-white">
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2 text-center tracking-tight">
            Equipment Supply <span className="text-[#eab308]">Portfolio</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl">
            ...
            <div className="flex flex-col gap-4 justify-center">
              ...
              <div className="bg-[#151f32] rounded-xl p-6 relative overflow-hidden shadow-md">
                <div className="flex items-start gap-4 relative z-10">
                  <div className="w-12 h-12 rounded-lg bg-[#eab308] text-white flex items-center justify-center text-2xl shrink-0 shadow-lg">🔥</div>
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-1">
                      <h3 className="text-white font-bold text-[15px]">Thermal Power Equipment</h3>
                      <span className="text-[#eab308] font-extrabold text-lg">45%</span>
                    </div>
                    ...
                    <div className="flex gap-6 border-t border-gray-700/50 pt-4">
                      <div>
                        <div className="text-[#eab308] font-bold text-sm">500+</div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-0.5">
                    ...
                    <span className="text-[#eab308] font-extrabold text-base">35%</span>
                  </div>
              ...
              {/* Bar 3 */}
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                <div className="w-10 h-10 rounded-lg bg-[#eab308] text-white flex items-center justify-center text-xl shrink-0 shadow-md">⚛️</div>
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-0.5">
                    <h3 className="text-gray-900 font-bold text-sm">Nuclear Power Equipment</h3>
                    <span className="text-[#eab308] font-extrabold text-base">20%</span>
                  </div>
            ...
            <div className="relative rounded-xl overflow-hidden shadow-lg h-[340px]">
              <img src="/new-heroes/power.jpeg" alt="Power Plant" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/20 to-transparent"></div>
              <div className="absolute bottom-6 left-6">
                <div className="inline-flex items-center gap-1.5 bg-[#eab308] text-white text-[10px] font-bold px-2 py-1 rounded mb-2">
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-gray-50">
          <div className="bg-amber-50 text-[#eab308] border border-amber-100 text-[10px] font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-wider">
            ⚙ PRODUCT RANGE
          </div>
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2 text-center tracking-tight">
            Comprehensive <span className="text-[#eab308]">Equipment Range</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-7xl">
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-5 grid grid-cols-2 gap-y-3 gap-x-2 text-[12px] text-gray-600 bg-white flex-1">
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Steam Turbines</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Gas Turbines</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Hydro Turbines</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Wind Turbines</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Generators</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Excitation Systems</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-5 grid grid-cols-2 gap-y-3 gap-x-2 text-[12px] text-gray-600 bg-white flex-1">
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Power Transformers</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Switchgear</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Circuit Breakers</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Protection Relays</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> HVDC Systems</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Smart Grid</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-5 grid grid-cols-2 gap-y-3 gap-x-2 text-[12px] text-gray-600 bg-white flex-1">
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> SCADA Systems</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> DCS Platforms</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Turbine Controls</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Grid Management</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Predictive Analytics</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Remote Monitoring</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-5 grid grid-cols-2 gap-y-3 gap-x-2 text-[12px] text-gray-600 bg-white flex-1">
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Cooling Towers</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Water Treatment</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Heat Exchangers</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Compressors</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Boiler Auxiliaries</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Piping Systems</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-5 grid grid-cols-2 gap-y-3 gap-x-2 text-[12px] text-gray-600 bg-white flex-1">
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Battery Systems (BESS)</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Pumped Hydro</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Flywheel Storage</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Thermal Storage</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Inverters (PCS)</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Energy Management</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="p-5 grid grid-cols-2 gap-y-3 gap-x-2 text-[12px] text-gray-600 bg-white flex-1">
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Vibration Analysis</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Thermography</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Oil Testing Kits</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Relay Testers</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> High Voltage Testing</div>
                <div className="flex items-center gap-1.5"><span className="text-[#eab308]">›</span> Emissions Monitoring</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-[#0a1120] border-y border-gray-800 relative overflow-hidden">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-2 text-center tracking-tight relative z-10">
            From Generation to <span className="text-[#eab308]">Consumer</span>
          </h2>
          ...
          <div className="w-full max-w-6xl relative z-10 overflow-x-auto pb-4 custom-scrollbar">
            <div className="min-w-[800px] flex justify-between relative">
              ...
              <div className="flex flex-col items-center text-center relative z-10 w-32">
                <div className="w-11 h-11 rounded-lg bg-[#eab308] text-white flex items-center justify-center text-xl shadow-lg mb-4">⚡</div>
                <h4 className="text-white font-bold text-[13px] mb-1">Generation</h4>
                <div className="text-[#eab308] font-bold text-[11px] mb-1">11-33 kV</div>
              ...
              {/* Step 4 */}
              <div className="flex flex-col items-center text-center relative z-10 w-32">
                <div className="w-11 h-11 rounded-lg bg-amber-500 text-white flex items-center justify-center text-xl shadow-lg mb-4">📉</div>
                <h4 className="text-white font-bold text-[13px] mb-1">Sub-Transmission</h4>
                <div className="text-amber-600 font-bold text-[11px] mb-1">66-132 kV</div>
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w-6xl items-center">
            ...
            <div className="bg-[#151f32] rounded-xl p-6 shadow-xl border border-gray-800">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#eab308] flex items-center justify-center text-white text-sm">📦</div>
                  <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-[#1a2639] border border-gray-700/50 rounded-lg p-4">
                  <div className="flex items-center gap-1.5 text-gray-400 text-[10px] mb-2 uppercase"><span className="text-[#eab308]">🌍</span> Global Sourcing</div>
                  <div className="text-white font-bold text-xl">200+</div>
                  <div className="text-gray-500 text-[10px]">OEM Partners</div>
                </div>
                <div className="bg-[#1a2639] border border-gray-700/50 rounded-lg p-4">
                  <div className="flex items-center gap-1.5 text-gray-400 text-[10px] mb-2 uppercase"><span className="text-[#eab308]">⏱</span> Delivery Speed</div>
                  <div className="text-white font-bold text-xl">48hrs</div>
                  <div className="text-gray-500 text-[10px]">Express Available</div>
                </div>
                <div className="bg-[#1a2639] border border-gray-700/50 rounded-lg p-4">
                  <div className="flex items-center gap-1.5 text-gray-400 text-[10px] mb-2 uppercase"><span className="text-[#eab308]">📋</span> Product Range</div>
                  <div className="text-white font-bold text-xl">10K+</div>
                  <div className="text-gray-500 text-[10px]">SKUs in Stock</div>
                </div>
                <div className="bg-[#1a2639] border border-gray-700/50 rounded-lg p-4">
                  <div className="flex items-center gap-1.5 text-gray-400 text-[10px] mb-2 uppercase"><span className="text-[#eab308]">🎯</span> Quality Rate</div>
            ...
            <div>
              <div className="bg-amber-50 text-[#eab308] border border-amber-100 text-[10px] font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-wider inline-block">
                📦 SUPPLY CAPABILITIES
              </div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3 tracking-tight">
                Reliable Equipment <span className="text-[#eab308]">Supply</span>
              </h2>
              ...
              <div className="space-y-3 mb-8">
                <div className="bg-gray-50 rounded-lg p-4 flex items-start gap-4">
                  <div className="text-[#eab308] mt-0.5">✓</div>
                  <div>
              ...
              <a href="/contact" className="inline-flex bg-[#eab308] hover:bg-amber-600 text-white px-6 py-2.5 rounded-md font-semibold text-sm items-center gap-2 transition shadow-md">
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-gray-50">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full max-w-6xl">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
              <div className="w-12 h-12 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center text-xl mb-4">⚙️</div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
              <div className="w-12 h-12 rounded-full bg-amber-50 text-sky-500 flex items-center justify-center text-xl mb-4">🛡️</div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
              <div className="w-12 h-12 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center text-xl mb-4">⚡</div>
        ...
        <section className="py-20 px-6 md:px-12 flex flex-col items-center bg-white">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2 text-center tracking-tight">
            Complete <span className="text-[#eab308]">Supply Solutions</span>
          </h2>
          <p className="text-gray-500 mb-12 text-center max-w-2xl text-[15px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex gap-5 hover:shadow-md transition-shadow relative overflow-hidden">
              ...
              <div className="w-12 h-12 rounded-full bg-amber-50 text-[#eab308] flex items-center justify-center text-xl shrink-0">📦</div>
              <div>
